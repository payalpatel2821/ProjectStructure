 ...
 * Use the [RegistrationStep3Fragment.newInstance] factory method to
...
class RegistrationStep3Fragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RegistrationStep3Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RegistrationStep3Fragment().apply {
