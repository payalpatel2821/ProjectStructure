 ...
 * Use the [RegistrationStep2Fragment.newInstance] factory method to
...
class RegistrationStep2Fragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RegistrationStep2Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RegistrationStep2Fragment().apply {
