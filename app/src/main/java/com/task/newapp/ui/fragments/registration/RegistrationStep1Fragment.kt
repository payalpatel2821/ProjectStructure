 ...
 * Use the [RegistrationStep1Fragment.newInstance] factory method to
...
class RegistrationStep1Fragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RegistrationStep1Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RegistrationStep1Fragment().apply {
