...
import com.task.newapp.utils.nicebottombar.Constants.DEFAULT_INDICATOR_COLOR
import com.task.newapp.utils.nicebottombar.Constants.DEFAULT_TEXT_COLOR
import com.task.newapp.utils.nicebottombar.Constants.DEFAULT_TEXT_COLOR_ACTIVE
import com.task.newapp.utils.nicebottombar.Constants.WHITE_COLOR_HEX
...
class NiceBottomBar : View {
    ...
    private var itemTextSize = d2p(0.0f) //d2p(11.0f)
    ...
    private val titleSideMargins = d2p(0f) //d2p(12f)
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val additionalTopMargin = if (barIndicatorGravity == 1) 0f else 35f //10f
