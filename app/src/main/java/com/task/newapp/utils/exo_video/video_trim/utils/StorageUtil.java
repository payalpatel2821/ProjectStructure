...
public class StorageUtil {
    ...
    private static final String APP_DATA_PATH = "/Android/data/" + BuildConfig.APPLICATION_ID;
...
//                FirebaseCrashlytics.getInstance().setCustomKey("AppDataDir", e.getMessage());
...
//                FirebaseCrashlytics.getInstance().setCustomKey("CacheDir", ignored.getMessage());
...
//                FirebaseCrashlytics.getInstance().setCustomKey("ExternalCacheDirManual", e.getMessage());
//                FirebaseCrashlytics.getInstance().recordException(e);
