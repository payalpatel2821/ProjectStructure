...
class SlidePanelView : RelativeLayout {
    ...
    private val blinkSize = dpToPx(5f)
    ...
    var binding: ViewSlidePanelBinding =
        ViewSlidePanelBinding.inflate(LayoutInflater.from(context), this)
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        background = ContextCompat.getDrawable(context, R.drawable.chat_input_rounded_rectangle)
        isClickable = true

        updateBlinkDrawable(ContextCompat.getColor(context, R.color.red))
