...
class RecordCircleView : View {
    ...
    private val colorCircle: Int by lazy { ContextCompat.getColor(context, R.color.transparent) }
    private val colorLock: Int by lazy { ContextCompat.getColor(context, R.color.gray) }
    private val colorOrange: Int by lazy { ContextCompat.getColor(context, R.color.red) }
    ...
    var audioDrawable: Drawable = ResourcesCompat.getDrawable(resources, R.drawable.ic_voice, null)!!
    private val sendDrawable: Drawable by lazy { ResourcesCompat.getDrawable(resources, R.drawable.ic_send, null)!! }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val drawable: Drawable = if (sendButtonVisible) {
            sendDrawable.setTint(ContextCompat.getColor(context, R.color.theme_color))
            sendDrawable
        } else {
            audioDrawable.setTint(ContextCompat.getColor(context, R.color.theme_color))
            audioDrawable
        }
        ...
        if (sendButtonVisible) {
            ...
            lockBackgroundDrawable.alpha = 0
