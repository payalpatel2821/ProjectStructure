...
class FilterViewAdapter(private val mFilterListener: FilterListener, var act: AppCompatActivity, var path: String) : RecyclerView.Adapter<FilterViewAdapter.ViewHolder>() {
...
//        mPhotoEditor.setFilterEffect(mPairList.get(position).second);
