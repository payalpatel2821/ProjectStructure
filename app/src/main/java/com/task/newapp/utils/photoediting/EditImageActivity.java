package com.task.newapp.utils.photoediting;
...
import com.task.newapp.utils.photoediting.base.BaseActivity;
import com.task.newapp.utils.photoediting.filters.FilterListener;
import com.task.newapp.utils.photoediting.filters.FilterViewAdapter;
import com.task.newapp.utils.photoediting.tools.EditingToolsAdapter;
import com.task.newapp.utils.photoediting.tools.ToolType;
...
import static com.task.newapp.utils.photoediting.FileSaveHelper.isSdkHigherThan28;
...
//        Typeface mTextRobotoTf = ResourcesCompat.getFont(this, R.font.lato_bold);
        //Typeface mEmojiTypeFace = Typeface.createFromAsset(getAssets(), "emojione-android.ttf");

        mPhotoEditor = new PhotoEditor.Builder(this, mPhotoEditorView)
                .setPinchTextScalable(pinchTextScalable) //pinchTextScalable // set flag to make text scalable when pinch
...
//            mPhotoEditorView.getSource().setImageBitmap(myBitmap);
            mPhotoEditorView.getSource().setImageURI(Uri.fromFile(imgFile));
        }
